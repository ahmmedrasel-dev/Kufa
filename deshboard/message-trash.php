<?php
 ...
 $select = "SELECT * FROM contact WHERE deleteStatus = 2 ORDER BY id DESC";
                                ...
                                <tbody>
                                    <tr class="<?php if($message['readStatus'] == 1){
                                        ...
                                        <td class="text-center">
                                            <?php if($message['deleteStatus'] == 2): ?>
                                                <a class="btn btn-danger" href="delete-status.php?deleteStatusId=<?php echo $message['id']; ?>">Undo</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                </tbody>        
